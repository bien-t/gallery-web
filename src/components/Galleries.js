...
const useContextClick = () => {
    ...
    const [contextDetails, setContextDetails] = React.useState({})
    const handleClick = (id, typename) => (event) => {
...
function Galleries() {
    ...
    const [galleryAddDetails, setGalleryAddDetails] = React.useState({})
    ...
    const galleryAddOnChange = (event) => {
    ...
    const imageUploadSubmitForm = async (event) => {
        event.preventDefault()
    ...
    const imageUploadCloseForm = (event) => {
        event.preventDefault()
        setShowUploadImagesForm(false)
        setUploadImages([])
    }
    ...
    const imageClick = async (imageId, imageIndex) => {
    ...
    const renameContextOnChange = (event) => {
    ...
    const handleImageRename = async (event) => {
        event.preventDefault()
        await imageRename({
            variables: {
    ...
    const selectNewGallery = (event) => {
        setMoveToDetails(event.target.value)
    }

    const moveToSubmit = async (event) => {
        event.preventDefault()
    ...
    const handleGalleryRename = async (event) => {
        event.preventDefault()
        await galleryRename({
            variables: {
                name: contextMenu.contextDetails.name,
                            ...
                            <MoveList>
                                {
                                    ...
                                    JSON.parse(galleryList.userGalleries).map((gallery) => {
